package com.litebank.analytics.processor.config;
...
public class KafkaConsumerConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:analytics-processor}")
    ...
    public ConsumerFactory<String, TransactionCreatedEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.litebank.*");
